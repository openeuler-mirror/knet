...
## 版本说明
K-NET版本说明包含版本配套关系和每个版本的特性变更说明，具体请参见[release_note.md](./docs/zh/release_note.md)。
...
```
## 安装部署
K-NET的环境依赖和安装方式请参见installation.md。

## 快速入门
编译、安装、执行K-NET示例参考[quick_start教程](./docs/zh/quick_start.md)。
