...
感谢你有兴趣为`K-NET`项目做出贡献！  
为了保持项目质量和协作高效，请在提交代码或问题前仔细阅读以下内容。
...
在`K-NET`的代码仓库中，点击工具栏的 “Issues”，您可以找到其`Issue`列表。提交新问题或建议前，先确认以下几点：

✅ 没有重复的 `Issue`，请先搜索已有的 `Issue`，避免重复报告。
...
如果您有任何疑问或讨论，或是发现了本指南的不足，欢迎提交`Issue`的方式告知我们！感谢您对这个项目的贡献！