...
#define TCP_COOKIE_BITS 6
#define TCP_COOKIE_MASK (((uint32_t)1 << TCP_COOKIE_BITS) - 1)
#define TCP_COOKIE_TIME_BITS 24
#define TCP_COOKIE_TIME_SHIFT_BITS (32 - TCP_COOKIE_TIME_BITS)
#define TCP_COOKIE_TIME_MASK (((uint32_t)1 << TCP_COOKIE_TIME_BITS) - 1)
