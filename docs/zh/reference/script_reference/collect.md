...
|文件名称|文件内容|
|--|--|
|hw_info.txt|硬件信息：<li>CPU信息</li><li>网卡信息</li><li>内存信息</li>
|sw_info.txt|软件版本：<li>K-NET版本信息</li><li>DPDK版本信息</li><li>网卡驱动版本信息</li><li>Glibc版本信息</li><li>内核版本信息</li><li>OS版本信息</li>|
