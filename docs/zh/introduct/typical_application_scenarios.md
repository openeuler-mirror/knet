...
关于K-NET用户态协议栈加速特性的部署请参见[安装](../installation/installation_planning.md)，使用请参见[特性说明](../feature/DPDK_user-mode_virtual_bond.md)。
...
关于K-NET用户态协议栈加速特性的部署请参见[安装](../installation/installation_planning.md)，使用请参见[使用DPDK用户态虚拟Bond功能](../feature/DPDK_user-mode_virtual_bond.md)。
