...
K-NET网络加速套件，主要面向通用协议加速、网络安全加速业务场景，同时也面向通用计算业务、安全通信业务， 基于SP670网卡，提供用户态TCP/IP协议栈加速、IPsec硬件卸载加速特性。

-   用户态TCP/IP协议栈
-   IPsec硬件卸载

![](../figures/dpdk_arch.png)
...
K-NET网络安全加速主要为IPsec硬件卸载加速，主要含控制面协商、设备驱动：

-   控制面协商：主要包含Strongswan开源工具进行控制面使能国内加解密算法和国际算法密钥协商能力，生态工具实现控制SA（Security Association，安全联盟）/SP（Security Policy，安全策略）卸载。
-   设备驱动：主要包含网卡固件、网卡内核态驱动，实现网卡IPsec硬件卸载功能。

![](../figures/om_arch_0.png)
