...
-   [共线程接口](./shared_thread/share_api_list.md)
...
-   [零拷贝接口](./zero_copy/zero_api_list.md)
    -   [knet\_iovec](./zero_copy/knet_iovec.md)
    -   [knet\_zreadv](./zero_copy/knet_zreadv.md)
    -   [knet\_zwritev](./zero_copy/knet_zwritev.md)
    -   [knet\_mp\_alloc](./zero_copy/knet_mp_alloc.md)
    -   [knet\_mp\_free](./zero_copy/knet_mp_free.md)
