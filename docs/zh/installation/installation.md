...
5. 安装dpdk-hinic3驱动。
    ...
    2. 获取配套版本的tag。
        ...
        配套的dpdk-hinic3版本为[hinic-26.0.rc1-0331.r1](https://gitcode.com/openeuler/dpdk/tags/hinic3-26.0.rc1-0331.r1)，跳转查看对应的commitid。
        示意如下：

         ![](../figures/hinic3p2.png)

    3. 切换至配套版本tag，此处commitid为6601cc18。

        > [!NOTE]说明
        > 6601cc18即为获取到的commitid，请以实际获取值替换。
...
2. 切换分支。
K-NET版本为26.0.RC1，跳转查看commitid为95c4ef17。
