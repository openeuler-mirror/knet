...
-   **[升级BIOS（仅TM280网卡涉及）](#升级bios仅tm280网卡涉及)**  

-   **[（可选）配置物理机yum源](#可选配置物理机yum源)**  

-   **[安装SP670驱动（仅SP670网卡涉及）](#安装sp670驱动仅sp670网卡涉及)**  
...
1.  登录服务器节点，下载虚拟机镜像openEuler-22.03-LTS-SP4-everything-aarch64-dvd.iso上传至服务器。
    ...
    链接：[https://repo.openeuler.org/openEuler-22.03-LTS-SP4/ISO/aarch64/](https://repo.openeuler.org/openEuler-22.03-LTS-SP4/ISO/aarch64/)
...
1.  配置直通设备，请用户在物理机上操作。
    ...
    7.  在虚机xml中增加直通设备。
        ...
        3.  给enp6s0配置IP地址。
            ...
            > **说明：** 
            >_192.168.32.2/24_：用户根据实际情况配置IP和掩码。
