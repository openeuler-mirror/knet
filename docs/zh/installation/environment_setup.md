...
若用户需要在虚拟化环境上运行业务，还需要重新在虚拟机上安装SP233网卡驱动，可参考[《SP230 标准网卡 用户指南》](https://support.huawei.com/enterprise/zh/doc/EDOC1100575890/7e4bd2d6)中“软件安装/安装驱动和管理工具/一键安装驱动和管理工具”章节。虚拟机中无需重新安装固件，请执行以下命令安装驱动。
