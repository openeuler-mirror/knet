...
|用户态网卡bond|K-NET网络加速特性支持对2个用户态网口进行Bond，进行网络加速。|SP670|iPerf3 3.16|
...
|本地回环|K-NET网络加速特性支持本地回环功能。|SP670|iPerf3 3.16|
...
|软件版本|说明|
|--|--|
|Redis 6.0.20|示例软件，请参见[单进程模式加速](./single_process_model_acceleration.md)及[多进程模式加速](./multi_process_model_acceleration.md)。|
